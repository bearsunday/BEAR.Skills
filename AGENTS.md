...
BEAR.Skills is a collection of Codex Skills designed for BEAR.Sunday, a PHP resource-oriented framework. The primary goal is to provide automated code generation for BEAR.Sunday's ROA (Resource Oriented Architecture) components.
...
Refer to the Forward Trace™ debugging approach outlined in the global AGENTS.md.
